pipeline {
    agent any
    parameters {
        string(name: "APP_NAME", defaultValue: "co-com-pragma-api-clients", description: "Nombre de nuestra app.")
        string(name: "APP_VERSION", defaultValue: "latest", description: "Version de nuestra app.")
        string(name: "CONTAINER_NAME", defaultValue: "api-clients", description: "Nombre del contendor para nuestra app.")
        string(name: "APP_HOST_NAME", defaultValue: "api.privjaac.com", description: "DNS que apunta a nuestra app.")
        string(name: "APP_HOST_PORT", defaultValue: "9904", description: "Puerto de arranque de nuestra app.")
        string(name: "APP_PATH", defaultValue: "/api/clients", description: "Path principal de nuestra app.")
